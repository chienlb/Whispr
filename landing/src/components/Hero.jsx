    ...
    <section style={{ padding: '60px 0 40px 0', textAlign: 'center', position: 'relative' }}>
      ...
      <div class="container flex-col-center">
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '14px', flexWrap: 'wrap', width: '100%', marginBottom: '52px' }}>
          {/* Windows Download */}
          <a href="https://pub-e9c6e32e3a214a6882903c35717e07d2.r2.dev/Whispr%20Social%20Enterprise%20Setup%201.0.0.exe" download="Whispr Social Enterprise Setup 1.0.0.exe" class="btn-primary" style={{ minWidth: '220px', minHeight: '52px' }}>
        ...
        <div class="modal-overlay-fixed" onClick={() => setShowMacModal(false)}>
          <div class="card-centered modal-content-centered" onClick={e => e.stopPropagation()} style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <a href="https://pub-e9c6e32e3a214a6882903c35717e07d2.r2.dev/Whispr%20Social%20Enterprise%20Setup%201.0.0.exe" download="Whispr Social Enterprise Setup 1.0.0.exe" class="btn-primary" style={{ justifyContent: 'center', padding: '12px 20px' }}>
